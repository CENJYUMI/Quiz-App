...
import com.example.apexercise6.databinding.ActivityQuestionNo2Binding

class QuestionNo2 : AppCompatActivity() {
    private lateinit var binding: ActivityQuestionNo2Binding
    private var score: Int = 0

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityQuestionNo2Binding.inflate(layoutInflater)
        ...
        binding.NextBtn.setOnClickListener {
            val intent = Intent(this, QuestionNo3::class.java)
