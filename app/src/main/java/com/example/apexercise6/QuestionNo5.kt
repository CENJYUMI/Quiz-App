...
class QuestionNo5 : AppCompatActivity() {
    private lateinit var binding: ActivityQuestionNo5Binding
    private var score: Int = 0

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityQuestionNo5Binding.inflate(layoutInflater)
        ...
        binding.NextBtn.setOnClickListener {
            val intent = Intent(this, QuestionNo6::class.java)
