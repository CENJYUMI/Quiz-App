...
class QuestionNo3 : AppCompatActivity() {
    private lateinit var binding: ActivityQuestionNo3Binding
    private var score: Int = 0

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityQuestionNo3Binding.inflate(layoutInflater)
        ...
        binding.NextBtn.setOnClickListener {
            val intent = Intent(this, QuestionNo4::class.java)
